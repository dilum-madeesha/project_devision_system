...
const { register, login, refreshToken, logout, getProfile, updateProfile, changePassword, getAllUsers, getUserById, updateUserStatus, updateUser, deleteUser } = AuthController;
