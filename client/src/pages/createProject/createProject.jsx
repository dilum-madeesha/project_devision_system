    ...
    <Container maxW="1200px" py={8}>
      <VStack spacing={8}>
        <VStack spacing={4} textAlign="center">
          <Heading size="lg">Project Creation Management Center</Heading>
          <Text color="gray.600" maxW="600px">
            Welcome back, {user?.firstName || 'User'}. Manage and create new projects.
          </Text>
        </VStack>

        <SimpleGrid columns={{ base: 1, md: 1 }} spacing={8} w="full" maxW="800px">
