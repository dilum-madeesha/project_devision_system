...
const LaborCostListPage = () => {
  ...
  const handleAssignmentChange = (index, field, value) => {
    ...
    if (field === 'timeIn' || field === 'timeOut' || field === 'otHours' || field === 'hasWeekendPay') {
      ...
      assignment.totalCost = regularCost + otCost + weekendPayCost;
      ...
      <VStack spacing={2} align="stretch">
        {/* Breadcrumb Navigation */}
          ...
          <HStack justify="space-between">
            <Text color="gray.600">Track daily labor costs and employee work records</Text>
            <Link to="/addcost/labor/add">
            ...
            <Table variant="simple" size="sm" layout="fixed">
              <Thead backgroundColor={"blue.50"} >
                <Tr>
                  ...
                  <Th py={3} px={2}>Job Name</Th>
                  <Th py={3} px={2} width="250px">Description</Th>
                  <Th py={3} px={3}>Cost</Th>
                  <Th py={3} px={2} width="100px">Labors</Th>
...
export default LaborCostListPage;